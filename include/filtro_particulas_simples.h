#ifndef FILTRO_PARTICULAS_SIMPLES_H
#define FILTRO_PARTICULAS_SIMPLES_H
...
#include "filtro_particulas_simples/pose.h"
#include "filtro_particulas_simples/energia.h"

#define sign(a) (((a) < 0) ? -1 : (((a) > 0) ? 1 : 0))

using namespace std;

class Filtro_Particulas_Simples
{
	public:
		Filtro_Particulas_Simples(ros::NodeHandle n);
		virtual ~Filtro_Particulas_Simples();
	...
	private:
		...
		filtro_particulas_simples::energia energia_grid_[50000];
		filtro_particulas_simples::pose pose_grid_[50000];
